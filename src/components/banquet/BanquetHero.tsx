  ...
  return (
    <div className="relative w-full h-[65vh] min-h-[480px] overflow-hidden select-none border-b border-white/5 flex items-center justify-center text-center">
      ...
      <img
        ...
        alt="The Yash Grand Banquet Ballroom Seating"
        className={cn(
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 space-y-6">
        ...
        >
          ...
          <span className="italic font-light text-gold font-serif">in Royal Style</span>
        </motion.h2>
        ...
        >
          An exquisite setting near SMS College for royal weddings, grand wedding receptions, engagement ceremonies, family gatherings, birthday affairs, corporate meetings, and social celebrations.
        </motion.p>
      </div>
    </div>
  );
